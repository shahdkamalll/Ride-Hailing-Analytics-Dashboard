...
Rider experience during high-demand periods
Driver availability and engagement
Pricing consistency and customer expectations
Analysis Approach
Explored ride-level data to identify patterns in cancellations and completion rates
...
The analysis led to actionable recommendations focused on improving matching efficiency, optimizing driver allocation during peak hours, and reducing cancellation rates through better operational strategies.

**Recommendations Summary**
Improve driver distribution during peak hours to reduce waiting time
Enhance matching algorithms to reduce delays and cancellations
Stabilize pricing strategy to avoid sudden fare differences
Investigate driver churn and improve retention strategies
Identify high-cancellation drivers and apply targeted incentives
